...
extension TMDB {
    ...
    public func getMovieDetails(for movieId: Int, appending details: [DetailsAppendable]?, completion: @escaping TMBDResult<Movie>) {
        fetchObject(ofType: Movie.self, cacheConfig: Movies.details(movieId: movieId, append: details), endpoint: Movies.details(movieId: movieId, append: details), completion: completion)
    }

    /// Get all of the alternative titles for a movie
    public func getAlternativeMovieTitles(movieId: Int, completion: @escaping TMBDResult<AlternativeTitlesResponse>) {
        fetchObject(ofType: AlternativeTitlesResponse.self, cacheConfig: Movies.alternativeTitles(movieId: movieId), endpoint: Movies.alternativeTitles(movieId: movieId), completion: completion)
    }
    ...
    public func getMovieChanges(movieId: Int, completion: @escaping TMBDResult<ChangesResponse>) {
        fetchObject(ofType: ChangesResponse.self, cacheConfig: Movies.changes(movieId: movieId), endpoint: Movies.changes(movieId: movieId), completion: completion)
    }

    /// Get the cast and crew for a movie.
    public func getMovieCredits(movieId: Int, completion: @escaping TMBDResult<CreditsResponse>) {
        fetchObject(ofType: CreditsResponse.self, cacheConfig: Movies.credits(movieId: movieId), endpoint: Movies.credits(movieId: movieId), completion: completion)
    }
    ...
    public func getExternalIds(movieId: Int, completion: @escaping TMBDResult<ExternalIds>) {
        fetchObject(ofType: ExternalIds.self, cacheConfig: Movies.externalIds(movieId: movieId), endpoint: Movies.externalIds(movieId: movieId), completion: completion)
    }
    ...
    public func getMovieImages(movieId: Int, completion: @escaping TMBDResult<ImagesResponse>) {
        fetchObject(ofType: ImagesResponse.self, cacheConfig: Movies.images(movieId: movieId), endpoint: Movies.images(movieId: movieId), completion: completion)
    }

    /// Get the keywords that have been added to a movie
    public func getMovieKeywords(movieId: Int, completion: @escaping TMBDResult<KeywordsResponse>) {
        fetchObject(ofType: KeywordsResponse.self, cacheConfig: Movies.keywords(movieId: movieId), endpoint: Movies.keywords(movieId: movieId), completion: completion)
    }
    ...
    public func getMovieReleaseDates(movieId: Int, completion: @escaping TMBDResult<ReleaseDatesResponse>) {
        fetchObject(ofType: ReleaseDatesResponse.self, cacheConfig: Movies.releaseDates(movieId: movieId), endpoint: Movies.releaseDates(movieId: movieId), completion: completion)
    }

    /// Get the videos that have been added to a movie.
    public func getMovieVideos(movieId: Int, completion: @escaping TMBDResult<VideosResponse>) {
        fetchObject(ofType: VideosResponse.self, cacheConfig: Movies.videos(movieId: movieId), endpoint: Movies.videos(movieId: movieId), completion: completion)
    }

    /// Get a list of translations that have been created for a movie.
    public func getMovieTranslations(movieId: Int, completion: @escaping TMBDResult<TranslationsResponse>) {
        fetchObject(ofType: TranslationsResponse.self, cacheConfig: Movies.translations(movieId: movieId), endpoint: Movies.translations(movieId: movieId), completion: completion)
    }
    ...
    public func getMovieRecommendations(movieId: Int, pageNumber: PageNumber, completion: @escaping TMBDResult<PopularMoviesResponse>) {
        fetchObject(ofType: PopularMoviesResponse.self, cacheConfig: Movies.recommendations(movieId: movieId, pageNumber: pageNumber), endpoint: Movies.recommendations(movieId: movieId, pageNumber: pageNumber), completion: completion)
    }
    ...
    public func getSimilarMovies(for movieId: Int, pageNumber: PageNumber, completion: @escaping TMBDResult<PopularMoviesResponse>) {
        fetchObject(ofType: PopularMoviesResponse.self, cacheConfig: Movies.similarMovies(movieId: movieId, pageNumber: pageNumber), endpoint: Movies.similarMovies(movieId: movieId, pageNumber: pageNumber), completion: completion)
    }

    /// Get the user reviews for a movie.
    public func getReviews(for movieId: Int, pageNumber: PageNumber, completion: @escaping TMBDResult<ReviewsResponse>) {
        fetchObject(ofType: ReviewsResponse.self, cacheConfig: Movies.reviews(movieId: movieId, pageNumber: pageNumber), endpoint: Movies.reviews(movieId: movieId, pageNumber: pageNumber), completion: completion)
    }

    /// Get a list of lists that this movie belongs to.
    public func getLists(for movieId: Int, pageNumber: PageNumber, completion: @escaping TMBDResult<ListsResponse>) {
        fetchObject(ofType: ListsResponse.self, cacheConfig: Movies.lists(movieId: movieId, pageNumber: pageNumber), endpoint: Movies.lists(movieId: movieId, pageNumber: pageNumber), completion: completion)
    }
    ...
    public func getLatestMovie(completion: @escaping TMBDResult<Movie>) {
        fetchObject(ofType: Movie.self, cacheConfig: Movies.latest, endpoint: Movies.latest, completion: completion)
    }
    ...
    public func getNowPlayingMovies(pageNumber: PageNumber, completion: @escaping TMBDResult<NowPlayingMoviesResponse>) {
        fetchObject(ofType: NowPlayingMoviesResponse.self, cacheConfig: Movies.nowPlaying(pageNumber: pageNumber), endpoint: Movies.nowPlaying(pageNumber: pageNumber), completion: completion)
    }

    /// Get the top rated movies on TMDb.
    public func getTopRatedMovies(pageNumber: PageNumber, completion: @escaping TMBDResult<PopularMoviesResponse>) {
        fetchObject(ofType: PopularMoviesResponse.self, cacheConfig: Movies.topRated(pageNumber: pageNumber), endpoint: Movies.topRated(pageNumber: pageNumber), completion: completion)
    }
    ...
    public func getPopularMovies(pageNumber: PageNumber, completion: @escaping TMBDResult<PopularMoviesResponse>) {
        fetchObject(ofType: PopularMoviesResponse.self, cacheConfig: Movies.popular(pageNumber: pageNumber), endpoint: Movies.popular(pageNumber: pageNumber), completion: completion)
    }
    ...
    public func getUpcomingMovies(pageNumber: PageNumber, completion: @escaping TMBDResult<NowPlayingMoviesResponse>) {
        fetchObject(ofType: NowPlayingMoviesResponse.self, cacheConfig: Movies.upcoming(pageNumber: pageNumber), endpoint: Movies.upcoming(pageNumber: pageNumber), completion: completion)
    }
}
